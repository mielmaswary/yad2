<?php
     ...
     $sql="CREATE TABLE `ads` (
        ...
        `apartmentType` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
        `cityName` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL,
        `cityType` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
        `street` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL,
        `adressNum` int(8) DEFAULT NULL,
        `floor` int(4) DEFAULT NULL,
        `totalsFloors` int(4) DEFAULT NULL,
        `pillars` tinyint(1) DEFAULT NULL,
        `neighborhood` varchar(5) COLLATE utf8_unicode_ci DEFAULT NULL,
        ...
        `img1` varchar(300) COLLATE utf8_unicode_ci DEFAULT NULL,
        `img2` varchar(300) COLLATE utf8_unicode_ci DEFAULT NULL,
        `img3` varchar(300) COLLATE utf8_unicode_ci DEFAULT NULL,
