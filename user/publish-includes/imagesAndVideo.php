<div class="display-none">
     <div class="flex-row flex-wrap justify-space-around padding-16-8 font-size-small bright-grey">
         ...
         <div class="flex-rect-dashed margin-5 flex-column justify-end videoIcon background-size-20 flex-column padding-3prec">
          ...
          <div class="relative flex-rect main-img-btn margin-5 flex-column justify-end plus-icon background-size-20 flex-column padding-3prec">
     ...
     <div class="flex-row flex-wrap justify-space-around padding-16-8 font-size-small bright-grey">
          ...
          <div class="flex-rect-dashed margin-5 flex-column justify-end plus-icon background-size-20 flex-column padding-3prec">
               <div class="text-align-center ">העלאת תמונות</div>
          </div>
          <div class="flex-rect-dashed margin-5 flex-column justify-end plus-icon background-size-20 flex-column padding-3prec">
               <div class="text-align-center ">העלאת תמונות</div>
